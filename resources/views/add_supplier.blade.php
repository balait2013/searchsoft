                        ...
                        <div class="card">
                            <div class="card-body">
                              ...
                              @endif
                                ...
                                <form class="form-horizontal p-t-20" method="post" action="{{url('add-supplier')}}">
                                  @csrf
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="sup_name" class="form-control @error('sup_name') is-invalid @enderror" value="{{ old('sup_name') }}" required id="exampleInputuname3" placeholder="Enter Name">
                                                @error('sup_name')
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="input-group">
                                                ...
                                                <textarea name="sup_address" class="form-control @error('sup_address') is-invalid @enderror" required placeholder="Enter Address">{{ old('sup_address') }}</textarea>
                                                @error('sup_address')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="input-group">
                                                ...
                                                <input name="sup_mobile" type="text" class="form-control @error('sup_mobile') is-invalid @enderror" value="{{ old('sup_mobile') }}" required id="exampleInputEmail3" placeholder="Enter mobile">
                                                @error('sup_mobile')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="input-group">
                                                ...
                                                <input name="sup_email" type="email" class="form-control @error('sup_email') is-invalid @enderror" value="{{ old('sup_email') }}" required id="exampleInputEmail3" placeholder="Enter email">
                                                @error('sup_email')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="input-group">
                                                ...
                                                <input name="sup_gst" type="text" class="form-control @error('sup_gst') is-invalid @enderror" value="{{ old('sup_gst') }}" required id="exampleInputEmail3" placeholder="Enter GST">
                                                @error('sup_gst')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="input-group">
                                                ...
                                                <textarea name="sup_details" class="form-control @error('sup_details') is-invalid @enderror"  placeholder="Enter Details">{{ old('sup_details') }}</textarea>
                                                @error('sup_details')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
